                    ...
                    {showCardForm && (
                      <div style={{ marginTop: 10, padding: 14, borderRadius: 10, border: '1.5px solid #8B5CF630', backgroundColor: '#8B5CF608' }}>
                        ...
                        {stripeClientSecret && stripePromise && (
                          <Elements stripe={stripePromise} options={{ clientSecret: stripeClientSecret, appearance: { theme: document.documentElement.classList.contains('dark') ? 'night' : 'stripe', variables: { colorPrimary: '#8B5CF6', colorBackground: document.documentElement.classList.contains('dark') ? '#1a1a2e' : '#ffffff', colorText: document.documentElement.classList.contains('dark') ? '#e2e8f0' : '#1a1a2e', colorTextSecondary: document.documentElement.classList.contains('dark') ? '#94a3b8' : '#64748b', borderRadius: '8px', fontFamily: 'system-ui, -apple-system, sans-serif', fontSizeBase: '15px' } } }}>
