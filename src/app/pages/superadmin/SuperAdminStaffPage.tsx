...
const INITIAL_STAFF: StaffMember[] = [
  // Downtown Hugory Vet — Clinical
  { id: 'ST001', firstName: 'Marcus',   lastName: 'Webb',       role: 'Clinic Manager',       department: 'Management',  clinic: 'Downtown Hugory Vet',     email: 'marcus.webb@hugory.vet',     phone: '(555) 210-0001', status: 'Active',    initials: 'MW', avatarColor: '#F4A261', startDate: '2020-03-12', schedule: 'Mon–Fri, 8–5',   bio: 'Oversees day-to-day operations across all departments, scheduling, compliance, and staff development.', emergencyContact: 'Sarah Webb — (555) 210-9001', appointments: 0,  rating: 4.9 },
  { id: 'ST002', firstName: 'Priya',    lastName: 'Sharma',     role: 'Senior Veterinarian',  department: 'Clinical',    clinic: 'Downtown Hugory Vet',     email: 'priya.sharma@hugory.vet',    phone: '(555) 210-0002', status: 'Active',    initials: 'PS', avatarColor: '#8B5CF6', startDate: '2019-06-01', licenseNo: 'DVM-CA-48821', schedule: 'Mon–Sat, 9–6', specializations: ['Internal Medicine', 'Cardiology', 'Oncology'], bio: 'Board-certified in internal medicine with 12+ years of clinical experience specializing in feline and canine cardiac disorders.', emergencyContact: 'Raj Sharma — (555) 210-9002', appointments: 284, rating: 4.9 },
  { id: 'ST003', firstName: 'Elena',    lastName: 'Romero',     role: 'Veterinarian',          department: 'Clinical',    clinic: 'Downtown Hugory Vet',     email: 'elena.romero@hugory.vet',    phone: '(555) 210-0003', status: 'Active',    initials: 'ER', avatarColor: '#EC4899', startDate: '2022-01-15', licenseNo: 'DVM-CA-52234', schedule: 'Tue–Sat, 9–6', specializations: ['Dermatology', 'Exotic Animals'],             bio: 'Experienced in dermatological conditions and exotic species care including avian and reptile patients.', emergencyContact: 'Carlos Romero — (555) 210-9003', appointments: 176, rating: 4.7 },
  { id: 'ST004', firstName: 'James',    lastName: 'Holloway',   role: 'Veterinarian',          department: 'Clinical',    clinic: 'Downtown Hugory Vet',     email: 'james.holloway@hugory.vet',  phone: '(555) 210-0004', status: 'On Leave',  initials: 'JH', avatarColor: '#3B82F6', startDate: '2021-09-10', licenseNo: 'DVM-CA-49901', schedule: 'Mon–Fri, 8–5', specializations: ['Orthopedics', 'Surgery'],                   bio: 'Specializes in complex orthopedic procedures including TPLO and FHO surgeries. Currently on paternity leave.', emergencyContact: 'Kate Holloway — (555) 210-9004', appointments: 203, rating: 4.8 },
  { id: 'ST005', firstName: 'Tanya',    lastName: 'Brooks',     role: 'Lead Vet Tech',         department: 'Clinical',    clinic: 'Downtown Hugory Vet',     email: 'tanya.brooks@hugory.vet',    phone: '(555) 210-0005', status: 'Active',    initials: 'TB', avatarColor: '#06B6D4', startDate: '2020-07-20', schedule: 'Mon–Fri, 8–5',   specializations: ['Anesthesia', 'Critical Care'],              bio: 'Lead technician overseeing surgery prep, anesthesia monitoring, and critical care protocols.', emergencyContact: 'Dan Brooks — (555) 210-9005', appointments: 412, rating: 4.8 },
  { id: 'ST006', firstName: 'Devon',    lastName: 'Park',       role: 'Vet Technician',        department: 'Clinical',    clinic: 'Downtown Hugory Vet',     email: 'devon.park@hugory.vet',      phone: '(555) 210-0006', status: 'Active',    initials: 'DP', avatarColor: '#10B981', startDate: '2023-02-08', schedule: 'Mon–Fri, 10–7',  bio: 'Certified veterinary technician with a focus on client education and patient handling.', emergencyContact: 'Min Park — (555) 210-9006', appointments: 198, rating: 4.6 },
  { id: 'ST007', firstName: 'Claire',   lastName: 'Nguyen',     role: 'Front Desk Manager',    department: 'Front Desk',  clinic: 'Downtown Hugory Vet',     email: 'claire.nguyen@hugory.vet',   phone: '(555) 210-0007', status: 'Active',    initials: 'CN', avatarColor: '#A78BFA', startDate: '2021-04-05', schedule: 'Mon–Fri, 8–5',   bio: 'Manages front desk operations, appointment scheduling systems, and client communications.', emergencyContact: 'Tom Nguyen — (555) 210-9007', appointments: 0,  rating: 4.9 },
  { id: 'ST008', firstName: 'Oscar',    lastName: 'Petit',      role: 'Receptionist',          department: 'Front Desk',  clinic: 'Downtown Hugory Vet',     email: 'oscar.petit@hugory.vet',     phone: '(555) 210-0008', status: 'Probation', initials: 'OP', avatarColor: '#F59E0B', startDate: '2026-02-01', schedule: 'Tue–Sat, 9–6',   bio: 'New hire currently completing 90-day probationary orientation period.', emergencyContact: 'Anne Petit — (555) 210-9008', appointments: 0,  rating: 4.3 },
  { id: 'ST009', firstName: 'Sofia',    lastName: 'Krause',     role: 'Groomer',               department: 'Support',     clinic: 'Downtown Hugory Vet',     email: 'sofia.krause@hugory.vet',    phone: '(555) 210-0009', status: 'Active',    initials: 'SK', avatarColor: '#F472B6', startDate: '2022-05-16', schedule: 'Mon–Fri, 9–5',   bio: 'Certified professional groomer specializing in breed-standard cuts and medicated baths.', emergencyContact: 'Hans Krause — (555) 210-9009', appointments: 156, rating: 4.7 },

  // Westside Animal Care
  { id: 'ST010', firstName: 'Rachel',   lastName: 'Okoye',      role: 'Clinic Manager',        department: 'Management',  clinic: 'Westside Animal Care',    email: 'rachel.okoye@hugory.vet',    phone: '(555) 320-0001', status: 'Active',    initials: 'RO', avatarColor: '#C2671A', startDate: '2021-01-18', schedule: 'Mon–Fri, 8–5',   bio: 'Operations lead for Westside clinic, managing a team of 14 staff and overseeing quarterly compliance reviews.', emergencyContact: 'Emeka Okoye — (555) 320-9001', appointments: 0,  rating: 4.8 },
  { id: 'ST011', firstName: 'Nathan',   lastName: 'Cole',       role: 'Senior Veterinarian',   department: 'Clinical',    clinic: 'Westside Animal Care',    email: 'nathan.cole@hugory.vet',     phone: '(555) 320-0002', status: 'Active',    initials: 'NC', avatarColor: '#6366F1', startDate: '2018-11-01', licenseNo: 'DVM-CA-41102', schedule: 'Mon–Sat, 8–6', specializations: ['Neurology', 'Ophthalmology'],               bio: 'Veterinary neurologist with 14 years of experience in feline and canine neurological disorders.', emergencyContact: 'Linda Cole — (555) 320-9002', appointments: 310, rating: 5.0 },
  { id: 'ST012', firstName: 'Amara',    lastName: 'Diallo',     role: 'Veterinarian',          department: 'Clinical',    clinic: 'Westside Animal Care',    email: 'amara.diallo@hugory.vet',    phone: '(555) 320-0003', status: 'Active',    initials: 'AD', avatarColor: '#059669', startDate: '2023-08-01', licenseNo: 'DVM-CA-55678', schedule: 'Mon–Fri, 9–6', specializations: ['Preventive Medicine', 'Nutrition'],         bio: 'Passionate about preventive care and holistic nutrition plans for companion animals.', emergencyContact: 'Ibrahim Diallo — (555) 320-9003', appointments: 142, rating: 4.8 },
  { id: 'ST013', firstName: 'Lucas',    lastName: 'Vega',       role: 'Specialist',            department: 'Clinical',    clinic: 'Westside Animal Care',    email: 'lucas.vega@hugory.vet',      phone: '(555) 320-0004', status: 'Active',    initials: 'LV', avatarColor: '#374151', startDate: '2020-09-15', licenseNo: 'DVM-CA-46320', schedule: 'Wed–Sun, 10–7', specializations: ['Cardiology', 'Imaging'],                    bio: 'ACVIM-certified cardiologist providing specialist consultations and echocardiography services.', emergencyContact: 'Maria Vega — (555) 320-9004', appointments: 98, rating: 4.9 },
  { id: 'ST014', firstName: 'Hannah',   lastName: 'Morris',     role: 'Vet Technician',        department: 'Clinical',    clinic: 'Westside Animal Care',    email: 'hannah.morris@hugory.vet',   phone: '(555) 320-0005', status: 'Active',    initials: 'HM', avatarColor: '#0EA5E9', startDate: '2022-11-10', schedule: 'Mon–Fri, 8–5',   bio: 'Certified vet tech with experience in dental procedures and radiography.', emergencyContact: 'John Morris — (555) 320-9005', appointments: 224, rating: 4.7 },
  { id: 'ST015', firstName: 'Jordan',   lastName: 'Lee',        role: 'Receptionist',          department: 'Front Desk',  clinic: 'Westside Animal Care',    email: 'jordan.lee@hugory.vet',      phone: '(555) 320-0006', status: 'Active',    initials: 'JL', avatarColor: '#8B5CF6', startDate: '2024-01-08', schedule: 'Tue–Sat, 9–6',   bio: 'Enthusiastic client-facing team member with strong multi-line phone management skills.', emergencyContact: 'Pat Lee — (555) 320-9006', appointments: 0,  rating: 4.5 },
  { id: 'ST016', firstName: 'Felix',    lastName: 'Hartmann',   role: 'Lab Technician',        department: 'Lab',         clinic: 'Westside Animal Care',    email: 'felix.hartmann@hugory.vet',  phone: '(555) 320-0007', status: 'Active',    initials: 'FH', avatarColor: '#06B6D4', startDate: '2021-06-22', schedule: 'Mon–Fri, 7–4',   bio: 'ASCP-certified lab tech managing in-house diagnostics including CBC, chemistry, urinalysis, and cytology.', emergencyContact: 'Ingrid Hartmann — (555) 320-9007', appointments: 0, rating: 4.8 },

  // Northpark Pet Hospital
  { id: 'ST017', firstName: 'Veronica', lastName: 'Sato',       role: 'Clinic Manager',        department: 'Management',  clinic: 'Northpark Pet Hospital',  email: 'veronica.sato@hugory.vet',   phone: '(555) 430-0001', status: 'Active',    initials: 'VS', avatarColor: '#D97706', startDate: '2022-03-28', schedule: 'Mon–Fri, 8–5',   bio: 'Leads the Northpark team with a focus on patient experience, staff retention, and growth initiatives.', emergencyContact: 'Ken Sato — (555) 430-9001', appointments: 0,  rating: 4.9 },
  { id: 'ST018', firstName: 'Daniel',   lastName: 'Frost',      role: 'Veterinarian',          department: 'Clinical',    clinic: 'Northpark Pet Hospital',  email: 'daniel.frost@hugory.vet',    phone: '(555) 430-0002', status: 'Active',    initials: 'DF', avatarColor: '#3B82F6', startDate: '2023-05-01', licenseNo: 'DVM-CA-57840', schedule: 'Mon–Fri, 9–6', specializations: ['Emergency Medicine', 'Critical Care'],     bio: 'Emergency medicine specialist providing after-hours critical care and trauma response at Northpark.', emergencyContact: 'Alice Frost — (555) 430-9002', appointments: 247, rating: 4.8 },
  { id: 'ST019', firstName: 'Camille',  lastName: 'Dupont',     role: 'Vet Technician',        department: 'Clinical',    clinic: 'Northpark Pet Hospital',  email: 'camille.dupont@hugory.vet',  phone: '(555) 430-0003', status: 'Active',    initials: 'CD', avatarColor: '#F472B6', startDate: '2024-02-12', schedule: 'Mon–Fri, 10–7',  bio: 'Bilingual (EN/FR) veterinary technician skilled in post-op care and client discharge instructions.', emergencyContact: 'Pierre Dupont — (555) 430-9003', appointments: 189, rating: 4.6 },
  { id: 'ST020', firstName: 'Aiden',    lastName: 'Walsh',      role: 'Receptionist',          department: 'Front Desk',  clinic: 'Northpark Pet Hospital',  email: 'aiden.walsh@hugory.vet',     phone: '(555) 430-0004', status: 'Inactive',  initials: 'AW', avatarColor: '#9CA3AF', startDate: '2023-01-09', schedule: 'N/A',             bio: 'On extended leave. Role currently covered by temp staff.', emergencyContact: 'Siobhan Walsh — (555) 430-9004', appointments: 0, rating: 4.1 },
];
...
// ─── Add / Edit Drawer ────────────────────────────────────────
const ROLES: Role[] = [
  'Senior Veterinarian', 'Veterinarian', 'Specialist',
  'Lead Vet Tech', 'Vet Technician',
  'Front Desk Manager', 'Receptionist',
  'Clinic Manager', 'Groomer', 'Lab Technician',
];
